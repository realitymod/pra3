...
if (_kit == PRA3_kitSys_kitDetailsExpanded) then
{
...
else
{
	...
	PRA3_kitSys_kitDetailsExpanded = _kit;

	_kit call PRA3_fnc_kitDlg_populateVariants;
	_kit call PRA3_fnc_kitDlg_populateKitDetails;
