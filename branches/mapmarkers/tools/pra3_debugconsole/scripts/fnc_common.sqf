...
PRA3_fDebugConsole_showYesNo =
{
	...
	(uiNamespace getVariable "PRA3_RscDebugConsole") createDisplay "PRA3_DisplayDebugConsole_yesNo";
	waitUntil {!isNull(uiNamespace getVariable "PRA3_DisplayDebugConsole_yesNo")};
	((uiNamespace getVariable "PRA3_DisplayDebugConsole_yesNo") displayCtrl 2)
