...
else
{
	...
	ctrl(40) ctrlSetText format [
		"Core Version: %1",
		["core", "dot"] call PRA3_fnc_getVersion
	];
	ctrl(50) ctrlSetText format [
		"Mission Version: %1",
		["mission", "dot"] call PRA3_fnc_getVersion
	];
...
if (isNil "PRA3_debug_skipMissionStart") then
{
